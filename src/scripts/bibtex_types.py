types = {
    "article": {
        ...
        "optional": ["translator", "annotator", "commentator", "subtitle", "titleaddon", "editor", 
                     "editora", "editorb", "editorc", "journalsubtitle", "journaltitleaddon", "issuetitle", 
                     "issuesubtitle", "issuetitleaddon", "language", "origlanguage", "series", "volume",
    ...
    "book": {
        ...
        "optional": ["editor", "editora", "editorb", "editorc", "translator", "annotator", "commentator",
    ...
    "inbook": {
        ...
        "optional" ["bookauthor", "editor", "editora", "editorb", "editorc", "translator", "annotator", "commentator", "introduction",
                    ...
                    "publisher", "location", "isbn", "eid", "chapter", "pages", "addendum", "pubstate", "doi", "eprint", "eprintclass",
     ...
     "suppbook": {
        ...
        "optional" ["author", "title", "bookauthor", "editor", "editora", "editorb", "editorc", "translator", "annotator", "commentator",
                    ...
                    "booksubtitle", "booktitleaddon", "language", "origlanguage", "volume", "part", "edition", "volumes", "series", "number",
                    "note", "publisher", "location", "isbn", "eid", "chapter", "pages", "addendum", "pubstate", "doi", "eprint",
                    "eprintclass", "eprinttype", "url", "urldate"]
    },

     "booklet": {
        "required" ["author/editor", "title", "year/date"],
        "optional" ["subtitle", "titleaddon", "language", "howpublished", "type", "note", "location", "eid", "chapter", "pages",
    ...
    "incollection": {
        ...
        "optional" ["editor", "editora", "editorb", "editorc", "translator", "annotator", "commentator",
                    ...
                    "publisher", "location", "isbn", "eid", "chapter", "pages", "addendum", "pubstate",
    ...
    "misc": {
        "required" ["author/editor", "title", "year/date"],
        "optional" ["subtitle", "titleaddon", "language", "howpublished", "type", "version", "note",
                    "organization", "location", "month", "addendum", "pubstate", "doi", "eprint",
                    "eprintclass", "eprinttype", "url", "urldate"]
    },
    ...
    "proceedings": {
        ...
        "optional" ["editor", "subtitle", "titleaddon", "maintitle", "mainsubtitle", "maintitleaddon",
                    "eventtitle", "eventtitleaddon", "eventdate", "venue", "language", "volume",
                    "part", "volumes", "series", "number", "note", "organization", "publisher",
    ...
    "mvproceedings": {
        "required" ["title", "year/date"],
        "optional" ["editor", "subtitle", "titleaddon", "eventtitle", "eventtitleaddon", "eventdate",
    ...
    "inproceedings": {
        "required" ["author", "title", "booktitle", "year/date"],
        "optional" ["editor", "subtitle", "titleaddon", "maintitle", "mainsubtitle", "maintitleaddon",
                    "booksubtitle", "booktitleaddon", "eventtitle", "eventtitleaddon", "eventdate",
                    "venue", "language", "volume", "part", "volumes", "series", "number", "note",
                    "organization", "publisher", "location", "month", "isbn", "eid", "chapter", "pages",
    ...
    "thesis": {
        "required" ["author", "title", "type", "institution", "year/date"],
        "optional" ["subtitle", "titleaddon", "language", "note", "location", "month", "isbn", "eid",
                    "chapter", "pages", "pagetotal", "addendum", "pubstate", "doi", "eprint",
                    "eprintclass", "eprinttype", "url", "urldate"]
    },
